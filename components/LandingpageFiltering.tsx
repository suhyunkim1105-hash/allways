...
import './AllWaysOnboardingFlow.css';
...
export interface AllWaysOnboardingFlowProps {
...
export const AllWaysOnboardingFlow: React.FC<AllWaysOnboardingFlowProps> = ({ onFinish }) => {
...
export default AllWaysOnboardingFlow;
